  ...
  class PermissionsApi
    ...
    def delete_permission_with_http_info(permission_id, opts = {})
      ...
      if @api_client.config.client_side_validation && permission_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'permission_id' when calling PermissionsApi.delete_permission"
      end

      # resource path
      local_var_path = '/api/v1/permissions/{permission_id}'.sub('{permission_id}',
                                                                 CGI.escape(permission_id.to_s))
    ...
    def get_permissions_with_http_info(opts = {})
      @api_client.config.logger.debug 'Calling API: PermissionsApi.get_permissions ...' if @api_client.config.debugging
    ...
    def update_permissions_with_http_info(permission_id, opts = {})
      ...
      if @api_client.config.client_side_validation && permission_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'permission_id' when calling PermissionsApi.update_permissions"
      end
