...
module KindeApi
  ...
  class CreateUserRequestIdentitiesInner
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["email", "phone", "username"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["email", "phone", "username"])
