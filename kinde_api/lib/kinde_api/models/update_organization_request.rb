  ...
  class UpdateOrganizationRequest
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `KindeApi::UpdateOrganizationRequest` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `KindeApi::UpdateOrganizationRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
    ...
    def hash
      [name, external_id, background_color, button_color, button_text_color, link_color, background_color_dark,
       button_color_dark, button_text_color_dark, link_color_dark, theme_code, handle, is_allow_registrations].hash
    end
