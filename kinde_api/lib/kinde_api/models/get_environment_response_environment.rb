...
module KindeApi
  class GetEnvironmentResponseEnvironment
    ...
    # Your HotJar site ID.
    attr_accessor :hotjar_site_id

    # Your Google Analytics tag.
    attr_accessor :google_analytics_tag
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KindeApi::GetEnvironmentResponseEnvironment` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KindeApi::GetEnvironmentResponseEnvironment`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hotjar_site_id')
        self.hotjar_site_id = attributes[:'hotjar_site_id']
      end

      if attributes.key?(:'google_analytics_tag')
        self.google_analytics_tag = attributes[:'google_analytics_tag']
      end
      ...
      if attributes.key?(:'kinde_domain')
        self.kinde_domain = attributes[:'kinde_domain']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          code == o.code &&
          name == o.name &&
          hotjar_site_id == o.hotjar_site_id &&
          google_analytics_tag == o.google_analytics_tag &&
          is_default == o.is_default &&
          is_live == o.is_live &&
          kinde_domain == o.kinde_domain &&
    ...
    def hash
      [code, name, hotjar_site_id, google_analytics_tag, is_default, is_live, kinde_domain, custom_domain, logo, logo_dark, favicon_svg, favicon_fallback, link_color, background_color, button_color, button_text_color, link_color_dark, background_color_dark, button_text_color_dark, button_color_dark, button_border_radius, card_border_radius, input_border_radius, theme_code, color_scheme, created_on].hash
    end
