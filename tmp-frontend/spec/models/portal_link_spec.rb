...
# Unit tests for KindeFrontendApi::PortalLink
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KindeFrontendApi::PortalLink do
  let(:instance) { KindeFrontendApi::PortalLink.new }

  describe 'test an instance of PortalLink' do
    it 'should create an instance of PortalLink' do
      expect(instance).to be_instance_of(KindeFrontendApi::PortalLink)
    end
  end
