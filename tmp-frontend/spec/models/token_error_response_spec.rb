...
# Unit tests for KindeFrontendApi::TokenErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KindeFrontendApi::TokenErrorResponse do
  let(:instance) { KindeFrontendApi::TokenErrorResponse.new }

  describe 'test an instance of TokenErrorResponse' do
    it 'should create an instance of TokenErrorResponse' do
      expect(instance).to be_instance_of(KindeFrontendApi::TokenErrorResponse)
    end
  end
