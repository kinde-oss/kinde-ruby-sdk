...
# Unit tests for KindeFrontendApi::ErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KindeFrontendApi::ErrorResponse do
  let(:instance) { KindeFrontendApi::ErrorResponse.new }

  describe 'test an instance of ErrorResponse' do
    it 'should create an instance of ErrorResponse' do
      expect(instance).to be_instance_of(KindeFrontendApi::ErrorResponse)
    end
  end
