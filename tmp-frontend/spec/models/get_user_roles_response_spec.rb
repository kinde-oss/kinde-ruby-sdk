...
# Unit tests for KindeFrontendApi::GetUserRolesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KindeFrontendApi::GetUserRolesResponse do
  let(:instance) { KindeFrontendApi::GetUserRolesResponse.new }

  describe 'test an instance of GetUserRolesResponse' do
    it 'should create an instance of GetUserRolesResponse' do
      expect(instance).to be_instance_of(KindeFrontendApi::GetUserRolesResponse)
    end
  end
