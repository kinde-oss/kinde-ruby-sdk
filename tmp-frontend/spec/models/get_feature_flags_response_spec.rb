...
# Unit tests for KindeFrontendApi::GetFeatureFlagsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KindeFrontendApi::GetFeatureFlagsResponse do
  let(:instance) { KindeFrontendApi::GetFeatureFlagsResponse.new }

  describe 'test an instance of GetFeatureFlagsResponse' do
    it 'should create an instance of GetFeatureFlagsResponse' do
      expect(instance).to be_instance_of(KindeFrontendApi::GetFeatureFlagsResponse)
    end
  end
