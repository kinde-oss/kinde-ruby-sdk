...
# Unit tests for KindeFrontendApi::GetUserPropertiesResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KindeFrontendApi::GetUserPropertiesResponseData do
  let(:instance) { KindeFrontendApi::GetUserPropertiesResponseData.new }

  describe 'test an instance of GetUserPropertiesResponseData' do
    it 'should create an instance of GetUserPropertiesResponseData' do
      expect(instance).to be_instance_of(KindeFrontendApi::GetUserPropertiesResponseData)
    end
  end
