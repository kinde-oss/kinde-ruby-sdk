...
# Unit tests for KindeFrontendApi::GetEntitlementResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KindeFrontendApi::GetEntitlementResponse do
  let(:instance) { KindeFrontendApi::GetEntitlementResponse.new }

  describe 'test an instance of GetEntitlementResponse' do
    it 'should create an instance of GetEntitlementResponse' do
      expect(instance).to be_instance_of(KindeFrontendApi::GetEntitlementResponse)
    end
  end
