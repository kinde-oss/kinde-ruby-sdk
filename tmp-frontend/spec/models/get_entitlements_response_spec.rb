...
# Unit tests for KindeFrontendApi::GetEntitlementsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KindeFrontendApi::GetEntitlementsResponse do
  let(:instance) { KindeFrontendApi::GetEntitlementsResponse.new }

  describe 'test an instance of GetEntitlementsResponse' do
    it 'should create an instance of GetEntitlementsResponse' do
      expect(instance).to be_instance_of(KindeFrontendApi::GetEntitlementsResponse)
    end
  end
