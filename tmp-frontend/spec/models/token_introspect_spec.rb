...
# Unit tests for KindeFrontendApi::TokenIntrospect
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KindeFrontendApi::TokenIntrospect do
  let(:instance) { KindeFrontendApi::TokenIntrospect.new }

  describe 'test an instance of TokenIntrospect' do
    it 'should create an instance of TokenIntrospect' do
      expect(instance).to be_instance_of(KindeFrontendApi::TokenIntrospect)
    end
  end
